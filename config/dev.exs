...
config :tomato, TomatoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ZRbeEvuuIeHDVfSRhw0B38mnw1qAd/7v65d9qQFkUPIUt1dBX+4LVijr03+xgexL",
  watchers: [
...
config :tomato, TomatoWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/tomato_web/router\.ex$"E,
      ~r"lib/tomato_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
